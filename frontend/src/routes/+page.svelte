...
<div class="border rounded-lg p-4 w-[600px] mx-auto">
	<div class="w-full text-center text-4xl">seamless chat</div>
	<div class="grid grid-cols-4 gap-3 mt-4">
		{#each Object.entries(rooms) as [roomId, room]}
			{#if room.members.length > 0}
				<button
					class="border rounded-lg p-3 flex flex-col justify-between h-28 hover:bg-gray-100 transition-colors"
				...
				>
					<div class="flex flex-col w-full text-center justify-center h-full gap-1">
						...
						<div class="text-md text-white bg-blue-500 px-4 py-1 rounded-full w-fit mx-auto">
